...
A_User_ID = ['U_ID_1', 'U_ID_2', 'U_ID_2', 'U_ID_3', 'U_ID_4']
A_Datetime = [pd.to_datetime('11/26/2022 2:50:20'), pd.to_datetime('11/13/2022 17:14:20'), pd.to_datetime('11/13/2022 17:27:30'), pd.to_datetime('11/19/2022 19:35:59'), pd.to_datetime('11/19/2022 19:37:20')]
...
A_message_ID = [1, 2, 3, 4, 5]
Channel_Slug = ['public-support-full-stack', 'public-support-full-stack', 'public-support-full-stack', 'public-support-full-stack', 'public-support-full-stack']
...
Key_to_Q_Timestamp = ['11/26/2022 2:42:32', '11/13/2022 16:42:32', '11/13/2022 16:42:32', '11/19/2022 19:20:00', '11/19/2022 19:20:00']
A_Full_Name = ['Name_1', 'Name_2', 'Name_2', 'Name_3', 'Name_4']
A_Email = ['Email_1@gmail.com', 'Email_2@gmail.com', 'Email_2@gmail.com', 'Email_3@gmail.com', 'Email_4@gmail.com']
A_Permalink = ['Permalink_1', 'Permalink_2', 'Permalink_4', 'Permalink_6', 'Permalink_7']
A_Slack_username = ['User_1', 'User_2', 'User_2', 'User_3', 'User_4']
A_from_Bot = [0, 0, 0, 0, 0]
A_from_Agent = [0, 0, 0, 0, 0]
A_Datetime_Thread = [pd.to_datetime('11/26/2022 2:42:32'), pd.to_datetime('11/13/2022 16:42:32'), pd.to_datetime('11/13/2022 16:42:32'), pd.to_datetime('11/19/2022 19:20:00'), pd.to_datetime('11/19/2022 19:20:00')]
...
dict_output = {'A_User_ID':A_User_ID, 'A_Datetime':A_Datetime, 'A_Text':A_Text, 'A_message_ID':A_message_ID,
...
def run(df):
    ...
    """ ######################################################### 
    ADD A THIRD CONDITION: The author of the question being answered should not be the same author of the question
    that was answered in the previous answer.
    Adding this condition CHANGES THE EXPECTED OUTPUT.
    ############################################################# """
